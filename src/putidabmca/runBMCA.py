...
def runBMCA(runName, N_ITERATIONS=50000):
    ...
    cobra_model = cobra.io.read_sbml_model('../models/iJN1463_JS.xml')
    ...
    model = cobra.io.read_sbml_model('../models/iJN1463_JS.xml') 
    ...
    with pm.Model() as pymc_model:
        ...
        Ex_t = pm.Deterministic('Ex', initialize_elasticity(N, 'ex', b=0.05, sigma=1, alpha=5, m_compartments=m_compartments,
    ...
    with pymc_model:
        ...
        en_t = at.concatenate([e_measured, e_unmeasured], axis=1)[:, e_inds]
    ...
    with pymc_model:
        ...
        y_ss, vn_ss = ll.steady_state_pytensor(Ey_t, Ex_t, en_t, xn_t.T, n_exp=n_exp)
